...
export class AppsClient {
     ...
     */
    getAuthScheme(appId: string): Promise<AuthSchemeResponseDto> {
     ...
     * @return App auth settings returned.
     */
    upsertAuthScheme(appId: string, request: AuthSchemeDto): Promise<AuthSchemeResponseDto> {
        let url_ = this.baseUrl + "/api/apps/{appId}/auth";
        if (appId === undefined || appId === null)
            throw new Error("The parameter 'appId' must be defined.");
        url_ = url_.replace("{appId}", encodeURIComponent("" + appId));
     ...
     * @param appId The ID of the app.
     */
    deleteAuthScheme(appId: string): Promise<void> {
        let url_ = this.baseUrl + "/api/apps/{appId}/auth";
        if (appId === undefined || appId === null)
            throw new Error("The parameter 'appId' must be defined.");
        url_ = url_.replace("{appId}", encodeURIComponent("" + appId));
