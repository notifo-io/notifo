...
namespace Notifo.Domain.Apps
{
    public sealed class AppStore : IAppStore, ICounterTarget, IDisposable
    {
        ...
        public async Task<List<App>> QueryNonConfirmedEmailAddressesAsync(CancellationToken ct = default)
        {
        ...
        public async Task<List<App>> QueryAsync(string contributorId, CancellationToken ct = default)
        {
        ...
        public async Task<App?> GetAsync(string id, CancellationToken ct = default)
        {
            Guard.NotNullOrEmpty(id, nameof(id));
